...
MODEL_PATH="/mnt/localssd/VideoChat3/VideoChat3-4B"
...
OUTPUT_DIR="/mnt/localssd/VideoChat3/eval/base-visual-token-perturbations-r015"
WATCHDOG_LOG="/mnt/localssd/VideoChat3/gpu_exclusive_watchdog/eval_base-visual-token-perturbations-r015.jsonl"
...
setsid "${PROJECT_ROOT}/.venv/bin/torchrun" \
  --nproc-per-node=8 \
  --master-port=42000 \
  "${PROJECT_ROOT}/scripts/eval_videochat3_base_visual_token_perturbations.py" \
