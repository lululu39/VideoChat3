...
OUTPUT_DIR="/mnt/localssd/VideoChat3/eval/base-macro-temporal-compression"
WATCHDOG_LOG="/mnt/localssd/VideoChat3/gpu_exclusive_watchdog/eval_base-macro-temporal-compression.jsonl"
