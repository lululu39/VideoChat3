...
MODEL_PATH="${PROJECT_ROOT}/xtuner-videochat3/work_dir/stage3/vc3-4b-lact-fw4-fwonly-longvid5870-8xh100-gb16-img1fps-f512-s8k-fwlr2e5-randgate-seed42-ns5r1-stgr1-v6/20260830212914/hf-134"
...
OUTPUT_DIR="/mnt/localssd/VideoChat3/eval/v6-teacher-forced-ablation"
WATCHDOG_LOG="/mnt/localssd/VideoChat3/gpu_exclusive_watchdog/eval_v6-teacher-forced-ablation.jsonl"
...
setsid "${PROJECT_ROOT}/.venv/bin/torchrun" \
  --nproc-per-node=8 \
  --master-port=42000 \
  "${PROJECT_ROOT}/scripts/eval_videochat3_lact_teacher_forced_ablation.py" \
