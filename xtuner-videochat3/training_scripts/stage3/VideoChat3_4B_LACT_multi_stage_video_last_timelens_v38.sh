...
export WANDB_NAME=vc3-lact-l16-delta-parallel-3drope-multi_stage_video_last-timelens-r12624-v37hf200-4xh100-gb16-s8k-v38
...
export VIDEOCHAT3_MODEL_PATH=/mnt/localssd/VideoChat3/training/vc3-lact-l16-delta-3drope-parallel-alltokens-vitfwproj-llava0to30-qa495013-4xh100-gb16-f64-s8k-lr2e5-v37/20260910193237/hf-200
export VIDEOCHAT3_INIT_TAG=llava-v37-hf200-init
...
export VIDEOCHAT3_STAGE3_CACHE_DIR=/mnt/localssd/dataset/VideoChat3/TimeLens-100K/token_cache/v37hf200-all-s8k-v38
...
unset VIDEOCHAT3_MAX_STEPS VIDEOCHAT3_LR_SCHEDULE_STEPS VIDEOCHAT3_LLAVA_SMOKE
export CUDA_VISIBLE_DEVICES=4,5,6,7
export NNODES=1
export NPROC_PER_NODE=4
export MASTER_PORT=40248
