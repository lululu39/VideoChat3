...
export WANDB_NAME="vc3-4b-lact-linear16-delta-r4select-fwproj-timelens-rand12624-8xh100-gb16-video2fps-f448-s2k-lr2e5-nofwclip-v12"
...
export VIDEOCHAT3_STAGE3_CACHE_DIR="dataset_cache/cache_videochat3_4B_lact_r4select_timelens_random12624_v12"
export VIDEOCHAT3_TRAINING_TAG="linear16-delta-r4select-fw-projector-no-fw-clip-v12"
