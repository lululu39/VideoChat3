...
export WANDB_NAME="vc3-lact-l16-delta-3drope-serial-gate0-r4query-vitfwproj-timelens-r12624-8xh100-gb16-f448-s4k-lr2e5-clean-v28"
...
export VIDEOCHAT3_TRAINING_TAG="l16-delta-3dr-ser-g0-r4query-vitfwproj-s4k-v28"
...
export VIDEOCHAT3_FW_ORDER=serial
