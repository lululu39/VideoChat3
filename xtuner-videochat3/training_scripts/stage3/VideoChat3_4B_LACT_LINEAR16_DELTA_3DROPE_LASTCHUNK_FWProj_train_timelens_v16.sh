...
export WANDB_NAME="vc3-4b-lact-linear16-delta-3drope-tanh-lastchunk-fwproj-timelens-rand12624-8xh100-gb16-video2fps-f448-s1k-lr2e5-nofwclip-v16"
...
export VIDEOCHAT3_STAGE3_CACHE_DIR="dataset_cache/cache_videochat3_4B_lact_linear16_delta_3drope_lastchunk_timelens_random12624_s1k_v16"
export VIDEOCHAT3_TRAINING_TAG="linear16-delta-3drope-lastchunk-fwproj-s1k-v16"
...
export VIDEOCHAT3_LACT_GATE=tanh
