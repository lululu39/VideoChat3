...
export WANDB_NAME="vc3-4b-lact-linear16-delta-3drope-lineargate0p5-lastchunk-fwproj-timelens-rand12624-8xh100-gb16-video2fps-f448-s1k-lr2e5-nofwclip-v17"
...
export VIDEOCHAT3_STAGE3_CACHE_DIR="dataset_cache/cache_videochat3_4B_lact_linear16_delta_3drope_gate0p5_lastchunk_timelens_random12624_s1k_v17"
export VIDEOCHAT3_TRAINING_TAG="linear16-delta-3drope-gate0p5-lastchunk-fwproj-s1k-v17"
