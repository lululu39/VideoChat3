...
export WANDB_NAME="vc3-lact-l16-delta-no3drope-gate0p5-lastchunk-timelens-r12624-8xh100-gb16-f448-s1k-lr2e5-v18"
...
export VIDEOCHAT3_STAGE3_CACHE_DIR="dataset_cache/cache_videochat3_4B_lact_linear16_delta_no3drope_gate0p5_lastchunk_timelens_random12624_s1k_v18"
export VIDEOCHAT3_TRAINING_TAG="linear16-delta-no3drope-gate0p5-lastchunk-fwproj-s1k-v18"
...
export VIDEOCHAT3_LACT_3D_ROPE=0
