...
export WANDB_NAME="vc3-4b-lact-linear16-muon-r4select-fwproj-timelens-rand12624-8xh100-gb16-video2fps-f448-s8k-lr2e5-stateclip-v16"
...
export VIDEOCHAT3_STAGE3_CACHE_DIR="dataset_cache/cache_videochat3_4B_lact_linear16_muon_r4select_timelens_random12624_s8k_v16"
export VIDEOCHAT3_TRAINING_TAG="linear16-muon-r4select-fw-projector-s8k-fsdp-stateclip-v16"
