...
export WANDB_NAME="vc3-lact-l16-delta-3drope-parallel-gate0p5-gatelr2e3-lastchunk-timelens-r12624-8xh100-gb16-f448-s1k-lr2e5-v22"
...
export VIDEOCHAT3_STAGE3_CACHE_DIR="dataset_cache/cache_videochat3_4B_lact_linear16_delta_3drope_parallel_gate0_lastchunk_timelens_random12624_s1k_v19"
export VIDEOCHAT3_TRAINING_TAG="l16-delta-3dr-par-g05-gatelr100x-lastchunk-fwproj-s1k-v22"
...
export VIDEOCHAT3_LACT_GATE_LR=2e-3
...
export VIDEOCHAT3_LACT_GATE_INIT=0.5
