...
| v34 Base | Stopped, no ckpt | V+P | 每 chunk 均匀选 `floor(S/4)` 个原始空间 token | 用户在 step 67 停止；末20步 CE `0.2687`，7–26 步 CE 与 v33 接近，无原生评测 | `67/276`, 4K | `0.287312@67` | `8.959 / 6.635 / 31.417` | — | — | — | — |
