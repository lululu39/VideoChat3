...
**Status:** Running cleanly at step 9/417. Same Base initialization, trainable ViT/projector scope, data, optimizer, LR, schedule, global clip, global batch, and FSDP as v14; compression factor 1 sends every four-frame chunk output and timestamp to the LLM with 8K packs. Step 9 loss/grad norm is `0.3246/16.47`, stable time is about 7.0 s, peak reserved memory is below 19 GB, and ETA is about 55 minutes. W&B: [`v15`](https://wandb.ai/LVSM-Experiment/videochat3/runs/vc3-4b-base-r1all-vitproj-timelens-rand12624-8xh100-gb16-video2fps-f448-s8k-lr2e5-v15); launcher: `xtuner-videochat3/training_scripts/stage3/VideoChat3_4B_BASE_ALLTOKENS_ViTProj_train_timelens_v15.sh`; expected artifact: `.../<timestamp>/hf-417`.
