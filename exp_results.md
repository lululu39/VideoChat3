...
**Status:** Relaunching after the LACT execution-path optimization. The original 8K launch OOMed before step 1; the original 2K run reached step 2/455 with no checkpoint and a measured 11h47m ETA, then was stopped for diagnosis.
