...
- The single-update/apply math matches VideoLACT and its TTT-LVSM reference, but their validated training horizons are short: VideoLACT F64 has 7 effective updates, TTT-LVSM trains on 8 or 12 views, and the surveyed RLAct LLM recipes use 32K sequences with 4K chunks (7 effective updates). No reference recipe validates exact full BPTT over dozens or hundreds of updates.
